...
public class AlphaMetricsEndpoint {
    ...
    public AlphaMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public AlphaMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new AlphaMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class AlphaMetricResponse {
        ...
        AlphaMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
