 ...
 *
 * <p>A simple alpha.socket.client.annotation of setting up the disruptor with two event handlers that
...
public class Disruptor<T>
{
     ...
     *
     * <p>This method can be used as the start of a chain. For alpha.socket.client.annotation if the handler <code>A</code> must
     ...
     *
     * <p>This method can be used as the start of a chain. For alpha.socket.client.annotation if the processor <code>A</code> must
     * process events before handler <code>B</code>:</p>
     * <pre><code>dw.handleEventsWith(A).then(B);</code></pre>
     *
     ...
     * For alpha.socket.client.annotation if the handler <code>A</code> must process events before handler <code>B</code>:</p>
     *
