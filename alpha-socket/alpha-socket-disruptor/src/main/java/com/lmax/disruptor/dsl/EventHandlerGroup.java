...
public class EventHandlerGroup<T>
{
     ...
     *
     * <p>This method is generally used as part of a chain. For alpha.socket.client.annotation if the handler <code>A</code> must
     ...
     * after every {@link EventProcessor} in this group has processed the event.</p>
     *
     * <p>This method is generally used as part of a chain. For alpha.socket.client.annotation if <code>A</code> must
